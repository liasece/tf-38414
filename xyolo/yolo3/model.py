...
from tensorflow.keras.layers import Conv2D, Add, ZeroPadding2D, UpSampling2D, Concatenate, MaxPooling2D, Input, Lambda
from tensorflow.keras.layers import LeakyReLU
from tensorflow.keras.models import Model
from tensorflow.keras.regularizers import l2

from xyolo.yolo3.utils import compose
...
def create_model(input_shape, anchors, num_classes, weights_path, load_pretrained=True, freeze_body=2):
    ...
    image_input = Input(shape=(None, None, 3), name="images")
    h, w = input_shape
    num_anchors = len(anchors)

    y_true = [Input(shape=(h // {0: 32, 1: 16, 2: 8}[l], w // {0: 32, 1: 16, 2: 8}[l], \
                           num_anchors // 3, num_classes + 5), name= {0: "y_true_0", 1: "y_true_1", 2: "y_true_2"}[l]) for l in range(3)]
...
def create_tiny_model(input_shape, anchors, num_classes, weights_path, load_pretrained=True, freeze_body=2):
